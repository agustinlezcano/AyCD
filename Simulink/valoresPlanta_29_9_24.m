...
dir = 1;
pos = calcularTrayectoria2_prueba(vx_max, vhmax, ax_max, Hc, hx_cont, [estado_cont(1, 23), estado_cont(2, 23)+5], [-20,2.5], estado_cont, 0, dir); % [30.5,30] en posicion final
%posicion = calcularTrayectoria2_prueba(vx_max, vy_max, ax_max, Hc, hx_cont, p1, p0, estado_cont, tw, direccion);
